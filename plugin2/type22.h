...
class PLUGIN2_SHARED_EXPORT Type22 : public IType, public IPluginTypeFactory<Type22>
{
	Q_OBJECT
	Q_INTERFACES(IType)

	explicit Type22(const QVariant & parameters, QObject *parent = nullptr);

public:
	inline static QString	getTypeNameInternal()	{	return QStringLiteral("Type22");	};
	static QObject * createInternal(const QVariant & parameters, QObject * parent) {
		return new Type22(parameters, parent);
	};
